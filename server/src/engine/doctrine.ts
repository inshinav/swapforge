...
Edit this video. Keep the entire world and all motion exactly as in the source; completely replace [the subjects being swapped].
...
- world: location (concrete: "wet night city street with neon storefronts"), timeOfDay, light (direction, color temperature, named sources), weather, background (list of NAMED elements worth protecting in a KEEP list), reflections (every reflective element where identity may leak: puddles, chrome, visors, shop windows), surfaces (road, walls, materials).
